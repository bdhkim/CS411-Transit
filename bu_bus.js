...
function bu_bus(ori_lat, ori_lng, dest_lat, dest_lng)
{
    ...
    if (dest_arrival_time == 0)
    {
        ...
        return "You will get on a bus in " + waiting_time + " minute(s) if you walk to your nearest stop, but there are no travel time estimates from the (badly maintained) BU Bus API";
    }
    else
    {
